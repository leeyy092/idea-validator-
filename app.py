import os                                                                               
  ...
  def generate_followup_questions(idea):                                                                                
      prompt =                                                                                                          
  f"""你是一位极其直接、不留情面的商业验证顾问。用户有一个创业想法，你要用3个问题直接戳破他的假设，逼他面对现实。       
  ...
  def generate_report(idea, followup_answers, time_status, capital_level):                                            
      ...
      prompt = f"""你是一位收费                                                                                         
  500元/小时的商业验证顾问。用户付费请你帮他验证一个创业想法，你必须给出一份极度精简、可直接执行的交付物。              
  ...
  if st.session_state.step == 1:                                                                                        
      ...
      with col2:                                                                                                        
          capital_level = st.selectbox(                                                                               
              "启动资金量级",                                                                                           
              ["几乎为零（< 3000元）", "少量（3,000 - 10,000元）", "中等（1万 - 5万元）", "充裕（5万 - 10万元）",     
  "充足（10万元以上）"],                                                                                                
              key="capital_level",                                                                                    
          )                                                                                                             
  ...
  # ===== STEP 3: Report =====                                                                                          
      ...
      if "换方向" in verdict or "不建议" in verdict:                                                                    
          st.markdown(f"<div class='verdict-red'><strong>🎯 判定</strong><br/>{verdict.replace(chr(10),                 
  '<br/>')}</div>", unsafe_allow_html=True)                                                                             
      elif "谨慎" in verdict:                                                                                           
          st.markdown(f"<div class='verdict-yellow'><strong>🎯 判定</strong><br/>{verdict.replace(chr(10),              
  '<br/>')}</div>", unsafe_allow_html=True)                                                                             
      else:                                                                                                             
          st.markdown(f"<div class='verdict-green'><strong>🎯 判定</strong><br/>{verdict.replace(chr(10),               
  '<br/>')}</div>", unsafe_allow_html=True)                                                                             
  ...
  line.strip().startswith("2.") or line.strip().startswith("3.")]                                                       
